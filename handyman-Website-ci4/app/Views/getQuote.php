			...
			<div class="col-lg-12">
				<div class="breatcumb-content text-center">
					...
					<div class="breatcumb-content-text">
						<ul>
							<!-- <li><a href="#">home</a> <i class="fas fa-angle-right"></i> <span>Get A Quote</span></li> -->
						</ul>
					</div>	
				</div>
			</div>
		...
		<div class="row call-top">
			<div class="col-lg-6 col-md-6 col-sm-12">
				<div class="call-center-thumb">
					<img src="assets/images/project/call.jpg" alt="">
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-12">
				<div class="call-center-content">
					<h4>LIMITED PERIOD OFFER</h4>
					<h2>Get a demo cleaning on your first</h2>
					<h2>booking absolutely free.</h2>
					<div class="call-center-right-box">
						<div class="dreamit-button-two button-right2">
							<a href="#">Book Appointment</a>
						</div>
						<div class="call-center-single-box">
						...
						<div class="row">
                            ...
                            <div class="from-box">
                                <select  aria-label="Default select example">
                                    ...
                                    <option value="1">Plumbing Service</option>
                                    <option value="2">AC Maintenance Service</option>
                                    <option value="4">Carpenter Service</option>
                                    <option value="4">Electrician Service</option>
                                </select>
                            </div>
                            </div>
							<div class="col-lg-12 col-sm-12">
								<div class="from-box">
									<textarea name="massage" id="massage" cols="30" rows="10" placeholder="Service Details"></textarea>
								</div>
							</div>
							<div class="col-lg-12">
...
<!-- <div class="subscribe-area">
	<div class="container">
		<div class="row subscribe-color">
			...
			<div class="col-lg-6 col-md-6 col-sm-12">
				<div class="contact-form-box">	
					<form id="subscribe_form" action="mail.php" method="POST">
						<div class="from-box1">
