	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12">
				<div class="dreamit-section-title pb-10 text-center">
					<h5>PRICING PLAN</h5>
					<h2>Best Pricing Plan For</h2>
					<h2>Your <span>Project</span></h2>
			...
			<div class="row">
				<div class="col-lg-4 col-md-6">
					<div class="dremit-single-pricing-nox">
						<div class="dreamit-pricing-content">
							<div class="dreamit-pricing-top_bar">
								<div class="dreamit-pricing-title">
									<h2>Basic Pack</h2>
								</div>
								<div class="price-item">
									<span class="curencyp">$</span>
									<span class="tk">39</span>
									<span class="bottom-m">Month</span>
								</div>
							</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="dremit-single-pricing-nox">
						<div class="dreamit-pricing-content">
							...
							<div class="pricing-body">
								<ul>
									<li>Ten Brand Monitors</li>
									<li>Comprehensive Cleaning</li>
									<li>Priority 24/7 Support</li>
									<li>Enhanced Quality & Customer Satisfaction</li>
								</ul>
							</div>
						</div>
						<div class="pricing-button">
					...
					<div class="dremit-single-pricing-nox">
						<div class="dreamit-pricing-content">
							<div class="dreamit-pricing-top_bar">
								...
								<div class="price-item">
									<span class="curencyp">$</span>
									<span class="tk">129</span>
									<span class="bottom-m">Month</span>
								</div>
							</div>
							<div class="pricing-body">
								<ul>
									<li>Fifteen Brand Monitors</li>
									<li>Premium Cleaning Services</li>
									<li>VIP 24/7 Support</li>
									<li>Unparalleled Quality & Customer Satisfaction</li>
								</ul>
							</div>
						</div>
						<div class="pricing-button">
...
<!--==================================================-->
<!-- End dreamit pricing Area -->
<!--==================================================-->

<!--==================================================-->
<!--Start dreamit testimonial Area -->
<!--==================================================-->
<div class="testimonial-area style-three pt-70 pb-90">
	<div class="container">
		<div class="row">
